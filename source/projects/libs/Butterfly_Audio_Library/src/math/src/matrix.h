...
public:
	...
	constexpr const_col_iterator col_begin(size_type col) const noexcept { return const_col_iterator(data_.data() + col, n, 0); }
	constexpr const_col_iterator col_end(size_type col) const noexcept { return const_col_iterator(data_.data() + col + (m)*n, n, 0); }
	constexpr const_row_iterator row_begin(size_type row) const noexcept { return const_row_iterator(data_.data() + row * n, 0); }
	constexpr const_row_iterator row_end(size_type row) const noexcept { return const_row_iterator(data_.data() + (row + 1) * n, 0); }
